...
from RoroRobot.modules.helper_funcs.handlers import CMD_STARTERS, SpamChecker
from RoroRobot.modules.helper_funcs.misc import is_module_loaded
...
if is_module_loaded(FILENAME):
    ...
    from RoroRobot.modules.sql import disable_sql as sql
